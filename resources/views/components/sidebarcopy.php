    ...
    <div class="sidebar-menu-area">
        <ul class="sidebar-menu" id="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a  href="{{ route('users.index') }}"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>Listagem de Usuarios</a>
                    </li>
                    <!--<li>
                        <a  href="{{ route('usersGrid') }}"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Users Grid</a>
                    </li>
                    <li>
                        <a  href="{{ route('users.create') }}"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i>Criar Usuario</a>
                    </li>
                    <li>
                        <a  href="{{ route('users.show', ['id' => 1]) }}"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i> View Profile</a>
                    </li>-->
                </ul>
            </li>
