                ...
                <div class="card border">
                    <div class="card-body">
                        <form action="{{ route('veiculos.update', $veiculo->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Valor do caucão -->
                            <div class="mb-20">
                                <label for="caucao" class="form-label fw-semibold text-primary-light text-sm mb-8">Valor do caucão <span class="text-danger-600">*</span></label>
                                <input type="number" step="0.01" class="form-control radius-8" id="caucao" name="caucao" placeholder="Digite o valor da diária" value="{{ old('caucao', $veiculo->caucao) }}" required>
                            </div>
