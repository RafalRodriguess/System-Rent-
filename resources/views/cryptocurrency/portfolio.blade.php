                        ...
                        <table class="table bordered-table sm-table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a  href="{{ route('marketplaceDetails') }}" class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/crypto/crypto-img3.png') }}" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                            <span class="flex-grow-1 d-flex flex-column">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a  href="{{ route('marketplaceDetails') }}" class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/crypto/crypto-img4.png') }}" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                            <span class="flex-grow-1 d-flex flex-column">
