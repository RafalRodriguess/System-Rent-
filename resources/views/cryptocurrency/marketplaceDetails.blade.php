    ...
    var options = {
        ...
        fill: {
            ...
            gradient: {
                ...
                gradientToColors: ["#01602a"], // Bottom gradient color (with transparency)
                ...
                <div class="card-body px-24 py-32">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-24">
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('assets/images/crypto/bitcoin.png') }}" alt="" class="w-72-px h-72-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                ...
                <div class="card-body p-0">
                                ...
                                <div class="">
                                    ...
                                    <div class="mt-24 border radius-8 position-relative">
                                        ...
                                        <div class="p-16 d-flex align-items-center border-bottom">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between flex-grow-1 ps-16">
                                                <div class="d-flex align-items-center gap-8">
                                                    <img src="{{ asset('assets/images/crypto/crypto-img1.png') }}" alt="" class="w-24-px h-24-px rounded-circle flex-shrink-0 overflow-hidden">
                                                    <div class="flex-grow-1 d-flex flex-column">
                                        ...
                                        <div class="p-16 d-flex align-items-center">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between flex-grow-1 ps-16">
                                                <div class="d-flex align-items-center gap-8">
                                                    <img src="{{ asset('assets/images/crypto/paypal.png') }}" alt="" class="w-24-px h-24-px rounded-circle flex-shrink-0 overflow-hidden">
                                                    <div class="flex-grow-1 d-flex flex-column">
                    ...
                    <div class="px-24 py-20">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-8 py-16 border-bottom">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('assets/images/crypto/crypto-img1.png') }}" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1 d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-8 py-16 border-bottom">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('assets/images/crypto/crypto-img2.png') }}" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1 d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-8 py-16 border-bottom">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('assets/images/crypto/crypto-img5.png') }}" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1 d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-8 py-16">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('assets/images/crypto/crypto-img6.png') }}" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1 d-flex flex-column">
