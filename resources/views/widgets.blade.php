...
@php
        ...
        $script = '<script>
            ...
            createWidgetChart("new-user-chart", "#01602a");
            ...
            var options = {
                ...
                stroke: {
                    curve: "smooth",
                    colors: ["#01602a"], // Specify the line color here
                    width: 3
                },
                markers: {
                    size: 0,
            ...
            var options = {
                ...
                fill: {
                    type: "gradient",
                    colors: ["#01602a"], // Set the starting color (top color) here
                    gradient: {
                        shade: "light", // Gradient shading type
                        type: "vertical", // Gradient direction (vertical)
                        shadeIntensity: 0.5, // Intensity of the gradient shading
