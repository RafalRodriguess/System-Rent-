  ...
  createChartTwo('zoomAbleLineChart', '#01602a');
  // =========================== Zoom able Line Chart End ===============================
  ...
  // =========================== Line Chart With Data labels Start ===============================
    var options = {
        ...
        colors: ['#01602a'],  // Set the color of the series
        dataLabels: {
          enabled: true
        },
        stroke: {
  ...
  function createLineChart(chartId, chartColor) {
    var options = {
      ...
      colors: ['#01602a', '#FF9F29'],  // Set the color of the series
      dataLabels: {
          enabled: false
      },
      stroke: {
  ...
  createLineChart('doubleLineChart', '#01602a');
